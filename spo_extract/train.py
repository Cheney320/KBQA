...
if __name__ == '__main__':
    ...
    vocab = {}
    with open('bert/bert-base-chinese/vocab.txt', encoding='utf_8') as file:
    ...
    if os.path.exists('graph_model.bin'):
        ...
        subject_model = SubjectModel.from_pretrained('./bert/bert-base-chinese')
        subject_model.to(device)

        model = ObjectModel(subject_model)
        model.to(device)

    train_loader = data_generator(train_data, batch_size=32)
